...
export default function OrphanageDetails() {
  ...
  // route.params são parâmetros que a rota recebe
  ...
  function handleOpenGoogleMapRoutes() {
    // o ponto de interrogação antes do latitude e longitude quer dizer que
    // ele vai verificar se o orfanato existi antes de usar a propriedade,
    // com isso ele não vai dar erro
